...
const RaspberryDetail = () => {
    ...
    return (
        <main className="min-h-screen bg-[#FFF0F5]">
            ...
            <section className="bg-[#831843] text-white py-20 px-6 md:px-12">
                <div className="container mx-auto">
                        ...
                        <div className="mb-8">
                            ...
                            <div className="grid grid-cols-12 gap-1 h-3 md:h-4 bg-white/10 rounded-full overflow-hidden">
                                ...
                                <div className="col-span-3 bg-[#EC4899] rounded-l-full relative group cursor-pointer">
                                    <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white text-pink-900 text-xs py-1 px-2 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap font-bold">
            ...
            <section className="py-20 px-6 md:px-12 bg-[#FFF0F5]">
                        ...
                        {[
                            ...
                            <Reveal key={idx} delay={idx * 0.1}>
                                <div className="text-left group cursor-pointer">
                                    <div className="h-48 bg-white rounded-2xl mb-6 flex items-center justify-center text-6xl shadow-sm group-hover:shadow-md transition-shadow border border-pink-100">
                                        {item.icon}
                                    </div>
                                    <p className="font-bold text-pink-900/50 mb-1 tracking-widest text-sm">{item.step}</p>
                                    <h3 className="font-bold text-xl text-pink-950 mb-3 leading-normal py-1">{item.title}</h3>
                                    <p className="text-pink-900/60 text-sm leading-relaxed">{item.desc}</p>
                                </div>
                            </Reveal>
                        ))}
                    </div>
