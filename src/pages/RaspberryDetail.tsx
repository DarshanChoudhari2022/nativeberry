                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <Reveal>
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl rotate-1 hover:rotate-0 transition-transform duration-500">
                                <img
                                    src="/src/assets/lifestyle_raspberry.png"
                                    alt="Raspberry Lifestyle"
                        ...
                        <div className="lg:pl-10">
                            <Reveal delay={0.2}>
                                <h2 className="text-3xl md:text-5xl font-bold text-pink-900 font-script mb-6">
                                    {t('raspberry.hero.title')}
                                </h2>
                            </Reveal>
                            <Reveal delay={0.3}>
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-center gap-3 text-gray-700">
                                        ...
                                        <span>Pairs perfectly with dark chocolate</span>
                                    </li>
                                    <li className="flex items-center gap-3 text-gray-700">
                                        <span className="text-2xl">🍹</span>
                                        <span>Muddle into refreshing mocktails</span>
                                    </li>
                                    <li className="flex items-center gap-3 text-gray-700">
                                        <span className="text-2xl">🥯</span>
                                        <span>Top on cream cheese bagels</span>
                                    </li>
                                </ul>
                            </Reveal>
                        </div>
