                    ...
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        <Reveal>
                            <div className="relative rounded-3xl overflow-hidden shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-500">
                                <img
                                    src="/src/assets/lifestyle_strawberry.png"
                                    alt="Strawberry Lifestyle"
                        ...
                        <div className="lg:pl-10">
                            <Reveal delay={0.2}>
                                <h2 className="text-3xl md:text-5xl font-bold text-[#781B26] font-script mb-6">
                                    {t('strawberry.hero.title')}
                                </h2>
                            </Reveal>
                            <Reveal delay={0.3}>
                                ...
                                <ul className="space-y-4">
                                    <li className="flex items-center gap-3 text-gray-700">
                                        ...
                                        <span>Perfect for morning smoothie bowls</span>
                                    </li>
                                    <li className="flex items-center gap-3 text-gray-700">
                                        <span className="text-2xl">🥗</span>
                                        <span>Add to fresh spinach salads</span>
                                    </li>
                                    <li className="flex items-center gap-3 text-gray-700">
                                        <span className="text-2xl">🍰</span>
                                        <span>Classic garnish for desserts</span>
                                    </li>
                                </ul>
                            </Reveal>
                        </div>
